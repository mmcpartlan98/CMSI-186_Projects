 ...
 *                   output an appropriate message for pass/error.  If an exception is thrown, the test
...
//    Leap year
      ...
      try { System.out.println( CalendarStuff.isLeapYear( 1600L ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println ( false ); }
//    NOT a leap year
      System.out.print( "   Test for year 1700 (long): " );
      try { System.out.println( CalendarStuff.isLeapYear( 1700L ) ? "error" : "success" ); }
      catch( Exception e ) { System.out.println ( false ); }
//    NOT a leap year
      System.out.print( "   Test for year 1800 (int) : " );
      try { System.out.println( CalendarStuff.isLeapYear( 1800 ) ? "error" : "success" ); }
      catch( Exception e ) { System.out.println ( false ); }
//    NOT a leap year
      System.out.print( "   Test for year 1900 (int) : " );
      try { System.out.println( CalendarStuff.isLeapYear( 1900 ) ? "error" : "success" ); }
      catch( Exception e ) { System.out.println ( false ); }
//    Leap year
      System.out.print( "   Test for year 1992 (int) : " );
      try { System.out.println( CalendarStuff.isLeapYear( 1992 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println ( false ); }
//    NOT a leap year
      System.out.print( "   Test for year 1415 (long): " );
      try { System.out.println( CalendarStuff.isLeapYear( 1415L ) ? "error" : "success" ); }
      catch( Exception e ) { System.out.println ( false ); }
//    Leap year
      System.out.print( "   Test for year 1996 (long): " );
      try { System.out.println( CalendarStuff.isLeapYear( 1996L ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println ( false ); }
//    NOT a leap year
      System.out.print( "   Test for year 1995 (int) : " );
      try { System.out.println( CalendarStuff.isLeapYear( 1995 ) ? "error" : "success" ); }
      catch( Exception e ) { System.out.println ( false ); }
//    NOT a leap year
      System.out.print( "   Test for year 1215 (long): " );
      try { System.out.println( CalendarStuff.isLeapYear( 1215L ) ? "error" : "success" ); }
      catch( Exception e ) { System.out.println ( false ); }
//    Leap year
      System.out.print( "   Test for year 2004 (int) : " );
      try { System.out.println( CalendarStuff.isLeapYear( 2004 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println ( false ); }
//    NOT a leap year
      System.out.print( "   Test for year 1814 (long): " );
      try { System.out.println( CalendarStuff.isLeapYear( 1814L ) ? "error" : "success" ); }
      catch( Exception e ) { System.out.println ( false ); }
   }
...
//    Valid input
      ...
      try { System.out.println( CalendarStuff.isValidDate(  1,  1, 2000 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println( false ); }
//    Invalid input
      System.out.print( "   Test February 29, 2001  : " );
      try { System.out.println( CalendarStuff.isValidDate(  2, 29, 2001 ) ? "error" : "success" ); }
      catch( Exception e ) { System.out.println( false ); }
//    Valid input
      System.out.print( "   Test December 31, 2014  : " );
      try { System.out.println( CalendarStuff.isValidDate( 12, 31, 2014 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println( false ); }
//    Invalid input
      System.out.print( "   Test December 0, 2000   : " );
      try { System.out.println( CalendarStuff.isValidDate( 12,  0, 2000 ) ? "error" : "success" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Test December 32, 2005  : " );
      try { System.out.println( CalendarStuff.isValidDate( 12, 32, 2005 ) ? "error" : "success" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Test Zeroary 15, 2005   : " );
      try { System.out.println( CalendarStuff.isValidDate(  0, 15, 2005 ) ? "error" : "success" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Test Thirtember 1, 2005 : " );
      try { System.out.println( CalendarStuff.isValidDate( 13,  1, 2005 ) ? "error" : "success" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Test February 29, 2004  : " );
      try { System.out.println( CalendarStuff.isValidDate(  2, 29, 2004 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println( false ); }
   ...
   */
   static void test_dateEquals() {
      ...
      try { System.out.println( CalendarStuff.dateEquals(  2, 29, 2004, 2, 29, 2004 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Test December 29, 2004 with February 29, 2004  : " );
      try { System.out.println( CalendarStuff.dateEquals( 12, 29, 2004, 2, 29, 2004 ) ? "error" : "success" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Test February 29, 2004 with February 28, 2004  : " );
      try { System.out.println( CalendarStuff.dateEquals(  2, 29, 2004, 2, 28, 2004 ) ? "error" : "success" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Test February 28, 2004 with February 28, 2005  : " );
      try { System.out.println( CalendarStuff.dateEquals(  2, 28, 2004, 2, 28, 2005 ) ? "error" : "success" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Test February 20, 2000 with January 13, 2000  : " );
      try { System.out.println( CalendarStuff.dateEquals(  2, 20, 2000, 1, 13, 2000 ) ? "error" : "success" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Test February 20, 2000 with January 20, 2001  : " );
      try { System.out.println( CalendarStuff.dateEquals(  2, 20, 2001, 1, 20, 2001 ) ? "error" : "success" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Test February 20, 2000 with January 13, 2010  : " );
      try { System.out.println( CalendarStuff.dateEquals(  2, 20, 2000, 1, 13, 2010 ) ? "error" : "success" ); }
      catch( Exception e ) { System.out.println( false ); }
   ...
   */
   static void test_compareDate() {
      ...
      try { System.out.println( -1 == CalendarStuff.compareDate(  3, 15, 2005,  3, 15, 2006 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Test Ides of March 2005 with Ides of March 2005  : " );
      try { System.out.println(  0 == CalendarStuff.compareDate(  3, 15, 2005,  3, 15, 2005 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Test Ides of March 2006 with Ides of March 2005  : " );
      try { System.out.println(  1 == CalendarStuff.compareDate(  3, 15, 2006,  3, 15, 2005 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println( false ); }
   ...
   */
   static void test_toDayOfWeekString() {
      ...
      try { System.out.println(    "Sunday" == CalendarStuff.toDayOfWeekString( 1 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Checking for 'Monday'    : " );
      try { System.out.println(    "Monday" == CalendarStuff.toDayOfWeekString( 2 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Checking for 'Tuesday'   : " );
      try { System.out.println(   "Tuesday" == CalendarStuff.toDayOfWeekString( 3 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Checking for 'Wednesday' : " );
      try { System.out.println( "Wednesday" == CalendarStuff.toDayOfWeekString( 4 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Checking for 'Thursday'  : " );
      try { System.out.println(  "Thursday" == CalendarStuff.toDayOfWeekString( 5 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Checking for 'Friday'    : " );
      try { System.out.println(    "Friday" == CalendarStuff.toDayOfWeekString( 6 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Checking for 'Saturday'  : " );
      try { System.out.println(  "Saturday" == CalendarStuff.toDayOfWeekString( 7 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Checking for 'Zeroday'   : " );
      try { System.out.println(    "Friday" == CalendarStuff.toDayOfWeekString( 0 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Checking for 'Octoday'   : " );
      try { System.out.println(  "Saturday" == CalendarStuff.toDayOfWeekString( 8 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println( false ); }
   }
  /**
   * method to test the "daysBetween()" method in the CalendarStuff class
   ...
   */
   static void test_toMonthString() {
      ...
      try { System.out.println( "January" == CalendarStuff.toMonthString( 1 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Checking for 'February'   : " );
      try { System.out.println( "February" == CalendarStuff.toMonthString( 2 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Checking for 'March'      : " );
      try { System.out.println( "March" == CalendarStuff.toMonthString( 3 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Checking for 'April'      : " );
      try { System.out.println( "April" == CalendarStuff.toMonthString( 4 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Checking for 'May'        : " );
      try { System.out.println( "May" == CalendarStuff.toMonthString( 5 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Checking for 'June'       : " );
      try { System.out.println( "June" == CalendarStuff.toMonthString( 6 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Checking for 'July'       : " );
      try { System.out.println( "July" == CalendarStuff.toMonthString( 7 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Checking for 'August'     : " );
      try { System.out.println( "August" == CalendarStuff.toMonthString( 8 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Checking for 'September'  : " );
      try { System.out.println( "September" == CalendarStuff.toMonthString( 9 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Checking for 'October'    : " );
      try { System.out.println( "October" == CalendarStuff.toMonthString( 10 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Checking for 'November'   : " );
      try { System.out.println( "November" == CalendarStuff.toMonthString( 11 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Checking for 'December'   : " );
      try { System.out.println( "December" == CalendarStuff.toMonthString( 12 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Checking for 'Zeroary'    : " );
      try { System.out.println( "Zeroary" == CalendarStuff.toMonthString( 0 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println( false ); }

      System.out.print( "   Checking for 'Thirtember' : " );
      try { System.out.println( "Thirtember" == CalendarStuff.toMonthString( 13 ) ? "success" : "error" ); }
      catch( Exception e ) { System.out.println( false ); }
